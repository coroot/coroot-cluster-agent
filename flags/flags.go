...
var (
	...
	ConfigFile           = kingpin.Flag("config-file", "Path to a YAML file with static configuration (AWS integration settings and databases to monitor), merged with the configuration received from Coroot").Envar("CONFIG_FILE").String()
